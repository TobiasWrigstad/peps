...
**TODO** Shorten this considerably, and move the rest to appendix.
Explain that we are going to use atomic RC for immutables.
...
management. Stage 2 and 3 permits cycles.
...
Stage 2 will expand this list to collections and (via the `@immutable` decorator)
