...
**Deep** immutability is important to allow safe sharing between sub-interpreters.
...
immutable shared object C that illegally references the mutable object D.
Note that object C does not belong to either sub-interpreter, which
is why it is drawn outside of their heaps.
