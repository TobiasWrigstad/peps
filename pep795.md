...
3. Since immutable objects are safe from data races, it is
   possible to avoid per-object locking that is needed for reference 
   counting in free-threaded Python.
...
this example. (It's becoming immutable is what causes `__add__`
