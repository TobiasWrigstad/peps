...
parallel execution safety and performance.
...
objects across multiple threads requires deep immutability.
...
* Class Freezing: Freezing an instance of a user-defined class
  ...
  freezing an object also freezes the type object of its super
  classes.
