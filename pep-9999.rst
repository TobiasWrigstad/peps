...
TODO
https://discuss.python.org/t/adding-deep-immutability/92011/7
https://discuss.python.org/t/adding-deep-immutability/92011/57

Cashing
=======

TODO
https://discuss.python.org/t/adding-deep-immutability/92011/78
...
Making objects immutable in-place exacerbate this situation as
...
may lead to weaknessed which already exist in Python's current
typing story being exercised more frequently. As alluded to in the
...
but cannot rely on immutability. We would need a way of expressing
this in the type system. This could probably be done by annotating
...
"freezing", and the function that does to ``freeze()``. This is
...
Qualifying immutability and freezing with an additional "deep"
seems like adding extra hassle for unclear gains. (As proposed
`here <https://discuss.python.org/t/adding-deep-immutability/92011/6>`_).
